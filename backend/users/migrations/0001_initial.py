    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Обязательное поле. Укажите действующий email.', max_length=254, unique=True, verbose_name='email address')),
                ('first_name', models.CharField(help_text='Обязательное поле. Укажите ваше имя.', max_length=150, verbose_name='first name')),
                ('last_name', models.CharField(help_text='Обязательное поле. Укажите вашу фамилию.', max_length=150, verbose_name='last name')),
